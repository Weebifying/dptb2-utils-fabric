...
public class ModConfigs {
    ...
    public ModConfigs() {
        ...
        createNewConfig(othersMap, othersDefaultMap, "dptbotHost", "67.220.85.146", String.class);
        createNewConfig(othersMap, othersDefaultMap, "dptbotPort", "6268", Integer.class);
